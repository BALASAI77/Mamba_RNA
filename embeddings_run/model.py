...
try:
    ...
    print("Mamba-ssm not found. Falling back to mamba_minimal (SLOW, CPU-only).")
    try:
...
class BiMambaBlock(nn.Module):
    def __init__(self, config):
        ...
        if Mamba is None:
            raise ImportError("mamba_ssm package is not installed and mamba_minimal.py is missing.")
